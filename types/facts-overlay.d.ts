export declare const META_DIR = ".openclaw-facts";
export declare const OVERLAY_NAME = "index.json";
export declare function overlayPath(vaultPath: any): any;
/**
 ...
 */
export declare function createOverlayReader({ vaultPath, cacheMs, now, read, logger }?: {
 ...
 */
export declare function findConflicts(overlay: any, text: any): {
    factKey: string;
    entry: any;
    stale: any;
}[];
/** The block prepended ahead of contradicted retrieval text. */
export declare function renderAuthoritativeBlock(conflicts: any): string;
/**
 * Overlay one retrieved text. Returns the original when nothing conflicts, so
 * the caller can skip the rewrite entirely.
 */
export declare function overlayText(overlay: any, text: any): {
    changed: boolean;
    text: string;
    conflicts: {
        factKey: string;
 ...
 */
export declare function overlayToolResult(overlay: any, result: any): {
    result: any;
    conflicts: {
        factKey: string;
        entry: any;
